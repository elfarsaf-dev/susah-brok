      ...
      <div className="h-96 hero-bg">
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white px-4">
            <div className="mb-6">
              <div className="w-72 h-72 md:w-80 md:h-80 bg-transparent flex items-center justify-center mx-auto mb-1 mt-8">
                <img 
                  src={logoImage} 
              ...
              <p className="text-base md:text-lg leading-relaxed mb-8 max-w-4xl mx-auto px-6" data-testid="text-hero-description">
